...
#define   STCTRL				                 (*(volatile STCTRL_TAG *)(CORTEXM4_PERIPH_BASE_ADDRESS+ 0x010))
#define   STRELOAD											 (*((volatile u32 *)(CORTEXM4_PERIPH_BASE_ADDRESS+0x014)))
#define   STCURRENT											 (*((volatile u32 *)(CORTEXM4_PERIPH_BASE_ADDRESS+0x018)))
...
#define   RCGCTIMER											 (*((volatile u32*)( CORTEXM4_SYSTEM_CONTROL_BASE_ADDRESS  +0x604)))													
#define   RCGCWTIMER										 (*((volatile u32*)( CORTEXM4_SYSTEM_CONTROL_BASE_ADDRESS  +0x65C)))													
#define 	GPTMIMR(BASE_ADDRESS)					 (*((volatile GPTMIMR_Tag*)( BASE_ADDRESS  + GPTMIMR_OFFSET )))
#define 	GPTMRIS(BASE_ADDRESS)					 (*((volatile u32*)( BASE_ADDRESS  + GPTMRIS_OFFSET )))
#define 	GPTMICR(BASE_ADDRESS)					 (*((volatile u32*)( BASE_ADDRESS  + GPTMICR_OFFSET )))
